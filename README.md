...
| Class         | What it does                                                                                                                                                                  |
|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `IroQuant`    | Palette PNG encoder with adaptive color reduction. Images that already fit the palette are encoded losslessly. Applies an embedded ICC profile (`iCCP`) that ImageIO ignores. |
